 ...
 * 
 */
package com.application.employee.demo.controller;
...
public class EmployoeeController{
    ...
    public String findSrpingHello(Model model, @RequestParam Map<String, String> map) {
    ...
    public void findAjaxSpringHello(HttpServletResponse response, Model model, @RequestParam Map<String, String> map)
            throws IOException {
        // 获取人员信息
        List<EmployeeDTO> employeeList = this.testServiceImpl.findEmployeeByParam(map);
