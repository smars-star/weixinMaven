 ...
 <table  style="vertical-align:top;max-height: 850px;overflow: auto;">
	   ...
	   <tr>
	           ...
	           <td>
		             ...
		             <div id="showDepTreeID" style="width:198px;vertical-align: top;margin-top:0px;display: none;max-height: 150px;overflow: auto;position: absolute;background-color: #C1C1C1;" align=center >
  ...
  var zTree;
	...
	$(document).ready(function(){
		...
		//默认选择那个节点
		zTree.selectNode(zTree.getNodeByParam("id", ${weixinEmpDTO.department[0] }));
