...
function lib_bwcheck(){ //Browsercheck (needed)
    ...
    if( this.ie5 == 0 && this.ie4 == 0  && this.mac==0 && this.opera5==0 && this.ns6==0 && this.ns4==0  ){
       this.ie6 =1;
	}
...
oCMenu.barcolor="#f1f7eb" //The color of the background bar - Value: "color"

oCMenu.barwidth="78%" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.level[0].bgcoloroff="#f1f7eb" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"

oCMenu.level[0].bgcoloron="#aac095" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[1].bordercolor="#556b2f"
...
oCMenu.level[2].bordercolor="#556b2f"
...
cmTopMenuImage='&nbsp;&nbsp;&nbsp;<img src="../media/default/images/Darrow.gif">'

cmSubMenuImage='&nbsp;&nbsp;&nbsp;<img src="../media/default/images/Rarrow.gif">'
