...
artDialog.fn = artDialog.prototype = {
	...
	lock: function () {
		...
		var that = this,
			...
			lockMaskWrap;
			if (_$body[0].body){
				lockMaskWrap = that._lockMaskWrap || $(_$body[0].body.appendChild(document.createElement('div')));
			}else {
				lockMaskWrap = that._lockMaskWrap || $(_$body[0].appendChild(document.createElement('div')));
			}
			
			var lockMask = that._lockMask || $(lockMaskWrap[0].appendChild(document.createElement('div'))),
