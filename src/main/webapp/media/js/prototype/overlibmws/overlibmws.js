...
if(OLud('fgcolor'))var ol_fgcolor="#faffe9";
if(OLud('bgcolor'))var ol_bgcolor="#c9e09f";
if(OLud('cgcolor'))var ol_cgcolor="#d7e8b7";
if(OLud('textcolor'))var ol_textcolor="#000000";
if(OLud('capcolor'))var ol_capcolor="#556b2f";
if(OLud('closecolor'))var ol_closecolor="#749558";
...
if(OLud('width'))var ol_width=560;
...
if(OLns4)d.zIndex=z;else{var o=d.style;o.position='fixed';o.visibility='hidden';o.zIndex=z;}}
return d;
}
...
function OLcontentCaption(txt, title, close) {
    ...
    if (close) {
        closing += '<a href="' + cC + '" ' + closeevent + '="' + cC + '"' + (o3_closefontclass ? ' class="pull-right ' + o3_closefontclass + '">': '>' + OLlgfUtil(0, '', 'span', o3_closecolor, o3_closefont, o3_closesize)) + close + (o3_closefontclass ? '': OLlgfUtil(1, '', 'span')) + '</a></div>';
    }
    caption = (o3_captionfontclass ? '<div class="help-panel-heading"><div class="pull-left">': '' + OLlgfUtil(0, '', 'div', o3_capcolor, o3_captionfont, o3_captionsize)) + o3_capicon + title + OLlgfUtil(1, '', 'div') + (o3_captionfontclass ? '': '') + closing;
...
function OLcontentBackground(txt, image, hasfullhtml) {
    ...
    if (hasfullhtml) {
        ...
        t = '<table' + OLwd(1) + ' ' + 'height="' + o3_height + '"><tr><td colspan="3" height="' + o3_padyt + '"></td></tr><tr><td width="' + o3_padxl + '"></td><td valign="top"' + OLwd(2) + '>' + OLlgfUtil(0, o3_textfontclass, 'div', o3_textcolor, o3_textfont, o3_textsize) + txt + OLlgfUtil(1, '', 'div') + '</td><td width="' + o3_padxr + '"></td></tr><tr><td colspan="3" height="' + o3_padyb + '"></td></tr></table>';
    }
...
//LGF utilities
function OLbgLGF() {
    return '<div' + OLwd(1) + o3_height + ' ' + (o3_bgclass ? ' class="' + o3_bgclass + '"': o3_bgcolor + o3_bgbackground) + '>';
}
function OLfgLGF(t) {
    return OLlgfUtil(0, o3_textfontclass, 'div', o3_textcolor, o3_textfont, o3_textsize) + t + (OLprintPI ? OLprintFgLGF() : '') + OLlgfUtil(1, '', 'div');
}
function OLlgfUtil(end, tfc, ele, col, fac, siz) {
    if (end) return ('</' + (OLns4 ? 'font': ele) + '>');
    else return (tfc ? '<div class="' + tfc + '">': ('<' + (OLns4 ? 'font color="' + col + '" face="' + OLquoteMultiNameFonts(fac) + '" size="' + siz: ele + ' style="' + (ele == 'span' ? 'text-decoration:underline;': '')) + '">'));
}
...
function OLbaseLGF() {
    return ((o3_base > 0 && !o3_wrap) ? ('<table width="100%"' + (o3_bgclass ? ' class="' + o3_bgclass + '"': '') + '><tr><td height="' + o3_base + '"></td></tr></table>') : '') + '</div>';
}
function OLwd(a) {
